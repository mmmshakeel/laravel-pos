        ...
        <div class="card-body card-padding">
            ...
            <div class="row">
                <div class="col-sm-2 pull-right">
                    ...
                    <div class="col-sm-2">
                        <p class="c-black f-500">{{ date('d-m-Y', strtotime($purchase_order->created_at)) }}</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <div class="col-sm-12 po-contact-details-box-bg">
                        <div id="PoVendorDetails" class="po-contact-details-box">
                            ...
                            {{ $purchase_order->supplier->address }}, {{ $purchase_order->supplier->city }}
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    ...
                    <div class="col-sm-12 po-contact-details-box-bg m-t-30">
                        <div id="PoContactDetails" class="po-contact-details-box">
                            <div class="fg-line">
                                <textarea class="form-control" rows="6" name="supplier_contact">{{ $purchase_order->supplier_contact }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    ...
                    <select name="branch" class="selectpicker" data-live-search="true" onchange="updateBranchDetails(this.value);">
                        ...
                        @if ($branch->id == $purchase_order->ship_to_branch_id)
                            selected="selected"
                        @endif
                        >{{ $branch->code }}</option>
                        @endforeach
            ...
            <div class="row m-t-10">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group fg-line">
                                    ...
                                    <input type="text" name="purchase_rep" value="{{ $purchase_order->purchaseRep->code }}" class="form-control" disabled="disabled" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <select class="selectpicker" name="po_terms" id="poTerm" onchange="termChange();">
                                        ...
                                        @if ($term->id == $purchase_order->terms_id)
                                            selected="selected"
                                        @endif
                            ...
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <input class="form-control date-picker" type="text" name="po_due_date" id="poDueDate" value=
                                    @if ($purchase_order->due_date)
                                        "{{ date('d-m-Y', strtotime($purchase_order->due_date)) }}"
                                    @else
                                        ""
                                    @endif
                                     />
                                ...
                                <div class="form-group fg-line">
                                    ...
                                    <select class="selectpicker" name="po_ship_via">
                                        ...
                                        <option value="{{ $service->id }}"
                                            @if ($service->id == $purchase_order->shipping_service_id)
                                                selected="selected"
                                            @endif
                                        >{{ $service->name }}</option>
                                        @endforeach
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <input class="form-control date-picker" type="text" name="po_delivery_date" value=
                            ...
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <input class="form-control date-picker" type="text" name="po_expiry_date" value=
                                    @if ($purchase_order->expiry_date)
                                        "{{ date('d-m-Y', strtotime($purchase_order->expiry_date)) }}"
                                    @else
                                        ""
                                    @endif
                                    />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <input class="form-control" name="po_tax_invoice_number" value="{{ $purchase_order->tax_invoice_number }}" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    <p class="m-b-5 c-black"><label>Invoice Date</label></p>
                                    <input class="form-control date-picker" type="text" name="po_tax_invoice_date" value=
                                    @if ($purchase_order->tax_invoice_date)
                                        "{{ date('d-m-Y', strtotime($purchase_order->tax_invoice_date)) }}"
                                    @else
                                        ""
                                    @endif
                                    />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <input class="form-control" name="po_supplier_invoice_number" value="{{ $purchase_order->supplier_invoice_number }}" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    <p class="m-b-5 c-black"><label>Date</label></p>
                                    <input class="form-control date-picker" type="text" name="po_supplier_invoice_date" value=
                                    @if ($purchase_order->supplier_invoice_date)
                                        "{{ date('d-m-Y', strtotime($purchase_order->supplier_invoice_date)) }}"
                                    @else
                                        ""
                                    @endif
                                    />
                        ...
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <input class="form-control" name="po_shipment_tarcking_no" value="{{ $purchase_order->shipment_tracking_number }}" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    <p class="m-b-5 c-black"><label>Weight (kg)</label></p>
                                    <input class="form-control" name="po_weight" type="number" value="{{ $purchase_order->weight_kg }}" />
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    ...
                                    <input class="form-control" name="po_reference" type="text" value="{{ $purchase_order->reference }}" />
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group fg-line">
                                    <p class="m-b-5 c-black"><label>Loc/Sub-Loc</label></p>
                                    <input class="form-control" value="{{ $purchase_order->location->code }}" disabled="disabled"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-4">
                    ...
                    <button class="btn btn-lg bgm-teal btn-block waves-effect m-t-20">Update Purchase Order</button>
                </div>
            </div>
        </div>
    </div>
