        ...
        $("#data-table-command").bootgrid({
            ...
            formatters: {
                "commands": function(column, row) {
                    return'<a href="purchase-orders/print/' + row.id + '"><button type="button" class="btn btn-icon command-print m-r-5" data-row-id="' + row.id + '"><span class="zmdi zmdi-print"></span></button></a>' +
                        '<a href="branch/edit/' + row.id + '"><button type="button" class="btn btn-icon command-edit m-r-5" data-row-id="' + row.id + '"><span class="zmdi zmdi-edit"></span></button></a>' +
