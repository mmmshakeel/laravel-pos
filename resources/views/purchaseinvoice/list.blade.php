        ...
        $("#data-table-command").bootgrid({
            ...
            formatters: {
                "commands": function(column, row) {
                    return'<a href="purchase-invoice/print/' + row.id + '" title="Print PO" target="_blank"><button type="button" class="btn btn-icon command-print m-r-5" data-row-id="' + row.id + '"><span class="zmdi zmdi-print"></span></button></a>' +
